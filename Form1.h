...
#pragma region Windows Form Designer generated code
        ...
        void InitializeComponent(void)
        {
			...
			this->Í‡Ú‡ÎÓ„ËToolStripMenuItem->Size = System::Drawing::Size(152, 22);
			...
			this->Ù‡ÈÎ˚ToolStripMenuItem->Size = System::Drawing::Size(152, 22);
			...
			// 
			this->Â‰‡ÍÚËÓ‚‡Ú¸ToolStripMenuItem1->Enabled = false;
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(214, 198);
			this->button3->Name = L"button3";
			this->button3->Size = System::Drawing::Size(142, 22);
			this->button3->TabIndex = 20;
			this->button3->Text = L"”‰‡ÎËÚ¸ ‚˚·‡ÌÌÓÂ";
...
private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
             //std::vector <File> F = 0;
			 ‰Ó·‡‚ËÚ¸ToolStripMenuItem->Enabled = false;
...
private: System::Void button3_Click(System::Object^  sender, System::EventArgs^  e) {
			if(checkedListBox1->CheckedItems->Count != 0) {
	           ...
	           for(int x = 0; x < checkedListBox1->CheckedItems->Count; checkedListBox1->CheckedItems->Count) {
			      char *nameofitem = new char[] = and_SysStringToChar(checkedListBox1->CheckedItems[x]->ToString());
                  string noi = nameofitem;
				/*   for (vector <File>::iterator i = Fx.begin(); i != Fx.end(); i++) {
					    if (Fx[ii].getname() == noi) 
							Fx.erase(i);  
							ii++;
						}    */
			   ...
			   System::Windows::Forms::MessageBox::Show(s, "”‰‡ÎÂÌ˚");
			   a.setdata(Fx);
	         }
             }
